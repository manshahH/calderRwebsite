...
export default function FloatingTextarea({ id, label, required, value, onChange, placeholder, ...props }) {
  ...
  return (
    <div className="relative w-full group">
      <textarea
        ...
        className="w-full bg-[#0C1220] border border-[rgba(255,255,255,0.07)] rounded-lg px-4 pt-7 pb-3 font-['Outfit'] text-[14px] text-[#E2E8F2] outline-none transition-colors duration-200 focus:border-[#3BAFD4] [color-scheme:dark] min-h-[140px] resize-y"
        {...props}
      />
      <label 
        htmlFor={id}
